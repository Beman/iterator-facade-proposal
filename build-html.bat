@echo off
pandoc --self-contained --css=styles.css --title-prefix="Iterator Facade" -f markdown_github+pipe_tables -t html -o iterator-facade-proposal.temp iterator-facade-proposal.md
